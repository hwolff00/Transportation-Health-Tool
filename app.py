...
cur.execute('''SELECT distinct(Metropolitan_Statistica_Area.name),
    Metropolitan_Statistica_Area.latitude,
    Metropolitan_Statistica_Area.longitude,
    Metropolitan_Statistica_Area.vehicle_perc,
    Metropolitan_Statistica_Area.public_perc,
    Metropolitan_Statistica_Area.auto_fatality,
    Metropolitan_Statistica_Area.bike_perc,
    Metropolitan_Statistica_Area.bike_fatality,
    Metropolitan_Statistica_Area.pedestrian_perc,
    Metropolitan_Statistica_Area.ped_fatality,
    Street.complete_street
...
df2 = pd.read_sql('''SELECT distinct(name), transit_trips, miles_per_cap,
    latitude, longitude FROM Urbanized_Area GROUP BY name
    ORDER BY transit_trips DESC''', conn)
# ------------------------------------------------------------------------------
...
app.layout = html.Div([
    ...
    # children=[] doesn't need to be typed for working program
    html.Div(id='output_container', children=[]),

    # figure={} doesn't need to be typed for working program
    dcc.Graph(id='THT_graph', figure={}),
