...
df['text'] = df['area'] + '<br>' + \
    ...
    'Commute by Car(%): ' + df['vehicle_perc'].astype(str) + '<br>' + \
    'Commute by Public Trans(%): ' + df['public_perc'].astype(str) + '<br>' + \
    'Commute by Bike(%): ' + df['bike_perc'].astype(str) + '<br>' + \
    'Commute by Foot(%): ' + df['pedestrian_perc'].astype(str) + '<br>' + \
